                ...
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10 text-white">
                    ...
                    >
                        ...
                        <div class="sm:col-span-6 mt-5">
                            ...
                            <div class="mt-1">
                                <input type="text" id="guest_number" name="guest_number" class="block w-full transition duration-150 ease-in-out appearance-none bg-slate-600 border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                            </div>
