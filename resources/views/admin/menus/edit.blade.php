                ...
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10 text-white">
                    ...
                    >
                        ...
                        <div class="sm:col-span-6 mt-5">
                            ...
                            <label for="image" class="block text-sm font-medium text-gray-300 mt-1"> Image </label>
                            ...
                            <div class="mt-1">
                                <input
                                    ...
                                    id="image"
                                    name="image"
                                    class="block w-full transition duration-150 ease-in-out appearance-none bg-slate-600 border border-gray-400 rounded-md py-2 px-3 text-base text-white leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5"
                                />
                            </div>
                            @error('image')
                                <div class="text-red-500 mt-2 text-sm">
                        ...
                        <div class="sm:col-span-6 mt-5">
                            ...
                            <div class="mt-1">
                                <textarea id="description" name="description" rows="3" class="shadow-sm focus:ring-indigo-500 appearance-none bg-slate-600 border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">{{ $menu->description }}</textarea>
                            </div>
                            @error('description')
                                <div class="text-red-500 mt-2 text-sm">
                                    {{ $message }}
