                ...
                <div class="flex flex-col md:flex-row">
                    <div class="h-32 md:h-auto md:w-1/2">
                        <img class="object-cover w-full h-full"
                             src="https://images.pexels.com/photos/20571439/pexels-photo-20571439/free-photo-of-seafood-in-bowl-on-table-in-restaurant.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="img" />
                    </div>
                    <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                        ...
                        <div class="w-full">
                            ...
                            <form
                                method="POST"
                                action="{{ route('reservations.store.step.one') }}"
                            >
                                ...
                                <div class="mt-1">
                                        <input
                                            ...
                                            name="res_date"
                                            min="{{
                                                $min_date->format('Y-m-d\TH:i:s')
                                            }}"
                                            max="{{
                                                $max_date->format('Y-m-d\TH:i:s')
                                            }}"
                                            value="{{
                                                $reservation ? $reservation->res_date->format('Y-m-d\TH:i:s') : ''
                                            }}"
                                            class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5"
                                        />
                                    </div>
